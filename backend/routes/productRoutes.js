...
const {
    getProducts,    // GET    — fetch all notes belonging to the authenticated user
    setProduct,     // POST   — create a new note
    updateProduct,  // PUT    — overwrite an existing note by ID
    deleteProduct   // DELETE — remove a note by ID
